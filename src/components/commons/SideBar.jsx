  ...
  return (
    ...
    <div class='side-menu-body'>
        <ul>
            ...
            <li class="open">
                ...
                <ul>
                    ...
                    <li><NavLink class="active" to="navs.html">Navs </NavLink></li>
            ...
            <li>
                <NavLink to="#">
                    <i class="icon ti-paint-roller"></i>
            ...
            <li class="side-menu-divider m-t-10">User Pages</li>
            <li><NavLink to="#"><i class="icon ti-face-smile"></i> <span>Authentication</span> </NavLink>
                <ul>
        ...
        <div class="side-menu-status-bars">
                ...
                <li class="list-inline-item">
                    <NavLink to="#">
                        <figure class="avatar avatar-state-warning avatar-xs">
                            <img src="http://borderless.laborasyon.com/assets/media/image/avatar.jpg" class="rounded-circle" alt=""/>
                        </figure>
                    </NavLink>
                </li>
                <li class="list-inline-item">
            ...
            <h6 class="text-uppercase font-size-11 m-b-10 d-flex justify-content-between">Storage <span
                    class="text-muted">%85</span></h6>
            <div class="progress" style={{height: "5px"}}>
                <div class="progress-bar bg-danger-gradient" role="progressbar" style={{width: "85%", ariavaluenow:"25",
